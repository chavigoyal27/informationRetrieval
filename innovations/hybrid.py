"""
hybrid.py — Hybrid Classification (Neural + Symbolic)
...
# Path setup to match your repo structure
...
OUTPUT_CSV = os.path.join(ANALYSIS_DIR, "hybrid_results.csv")
OUTPUT_TXT = os.path.join(ANALYSIS_DIR, "hybrid_report.txt")
...
class HybridClassifier:
    ...
    def __init__(self):
        ...
        # Simple rule patterns (universal)
...
def main():
    """Main entry point"""
    print("="*70)
    print("HYBRID CLASSIFIER FOR SENTIMENT ANALYSIS")
    print("Neural (RoBERTa) + Symbolic (Learned Patterns) + Rule-based")
    print("="*70)
    evaluate_hybrid()
